...
swipes_burnout.agentes.buscar_matches ainda nao existe.

Os testes do GRUPO C (repositorio) podem passar parcialmente, pois
swipes_burnout.repositorio ja esta implementado — mas sao incluidos aqui
...
from swipes_burnout.seed_data import PERFIL_TESTE, gerar_pool_perfis
...
def test_buscar_matches_existe(colecao_temp):
    """buscar_matches deve ser importavel de swipes_burnout.agentes (CONS-01)."""
    from swipes_burnout.agentes import buscar_matches  # RED: ImportError
...
def test_repositorio_busca_filtrada_por_genero(colecao_temp):
    ...
    from swipes_burnout.repositorio import ResultadoBusca
